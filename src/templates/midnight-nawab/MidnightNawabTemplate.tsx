...
const MidnightNawabTemplate = ({
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 text-center px-6">
          ...
          >
            <EditableText
              ...
              className="font-heading text-5xl sm:text-6xl md:text-7xl text-primary"
              as="h1"
            />
          </motion.div>
      ...
      >
        <div className="container mx-auto px-6 max-w-3xl">
          <div className="text-center mb-12">
            <Star
              className="w-6 h-6 text-primary mx-auto mb-4"
              fill="currentColor"
            />
            <EditableText
              ...
              className="font-body text-base text-foreground/70 max-w-xl mx-auto leading-relaxed"
              multiline
              as="p"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            ...
            >
              ...
              <EditableText
                ...
                mode={mode}
                placeholder="Bio..."
                className="font-body text-sm text-foreground/60 mt-1"
                maxLength={100}
                as="p"
              />
            </motion.div>
      ...
      {(data.showCountdown || mode === "edit") && (
        ...
        >
          <div className="container mx-auto px-4 max-w-2xl text-center">
            ...
            {data.showCountdown && (
              <NawabCountdown weddingDate={data.weddingDate} />
            )}
          </div>
        </motion.section>
      )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {data.events.map((event, i) => (
                ...
                >
                  ...
                  <p className="font-body text-sm text-foreground/80 mt-3">
                    {event.venueName}
                  </p>
      ...
      {/* RSVP */}
      {mode !== "edit" && (
        <NawabRsvp invitationId={data.invitationId} isDemo={mode === "demo"} />
      )}

      {/* Footer */}
      <footer
        className={cn("py-20 bg-card text-center", mode === "edit" && "pb-32")}
      >
        <div className="container mx-auto px-4">
          ...
          {data.hashtag && (
            <p className="font-body text-sm text-primary/70 mt-4">
              {data.hashtag}
            </p>
          )}
          <p className="font-body text-[10px] text-foreground/20 mt-10">
...
const NawabCountdown = ({ weddingDate }: { weddingDate: string }) => {
  ...
  if (!c)
    return <p className="font-body text-foreground/50">Set wedding date</p>;
  return (
      ...
      <div className="container mx-auto px-6 max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex justify-center gap-3">
            {[
              ...
              <button
                ...
                className={cn(
                  "px-5 py-3 rounded-lg font-body text-sm border transition-all",
                  attending === opt.value
          ...
          <button
            ...
            disabled={!attending}
            className={cn(
              "w-full py-3 rounded-lg font-body font-medium text-sm",
              attending
