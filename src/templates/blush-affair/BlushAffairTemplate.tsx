...
const BlushAffairTemplate = ({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: C.cream, fontFamily: FONTS.body }}
    >
      ...
      <footer
        ...
        style={{ backgroundColor: C.maroonDark }}
      >
        ...
        >
          ...
          {data.hashtag && (
            <p className="text-sm mt-4 italic" style={{ color: `${C.gold}70` }}>
              {data.hashtag}
            </p>
          )}
          <p className="text-[10px] mt-10" style={{ color: `${C.gold}40` }}>
...
const HeroSection = ({
  ...
  const couplePhoto =
    data.couplePhotoUrl || `${R2_BASE}/templates/7/photos/marriage.png`;
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        {mode === "edit" ? (
          <EditablePhoto
            ...
            alt="Couple Photo"
            placeholderText="Add Your Photo"
            invitationId={data.invitationId ?? undefined}
            templateId={templateId}
            sessionUUID={sessionUUID}
            uploadStage={uploadStage}
        ...
        <div
          ...
          style={{
            background: `linear-gradient(180deg, ${C.maroonDark}CC 0%, ${C.maroonDark}80 40%, ${C.maroonDark}DD 100%)`,
          }}
        />
      </div>
      ...
      <div
        className="absolute inset-4 md:inset-8 border-2 rounded-lg pointer-events-none"
        ...
        {[
          ...
          <div key={i} className={`absolute ${pos} w-12 h-12`}>
            <svg viewBox="0 0 50 50" fill="none" className="w-full h-full">
              <path
                d="M5 5 Q5 25 25 25 Q25 5 5 5 Z"
                stroke={C.gold}
                strokeWidth="1"
                fill="none"
                opacity="0.5"
        ...
        >
          <div style={{ fontFamily: FONTS.script, color: C.gold }}>
            <EditableText
              ...
              className="block text-5xl sm:text-6xl md:text-7xl drop-shadow-lg"
              as="h1"
            />
          </div>
          <p
            className="text-2xl my-2"
            style={{ fontFamily: FONTS.script, color: `${C.gold}80` }}
          >
            &amp;
          </p>
          <div style={{ fontFamily: FONTS.script, color: C.gold }}>
        ...
        {mode === "edit" ? (
          <div className="mt-4">
            ...
            <input
              ...
              className="bg-white/10 backdrop-blur border rounded-lg px-4 py-2 text-sm"
  ...
  <section className="py-20 md:py-28" style={{ backgroundColor: C.cream }}>
    <div className="max-w-2xl mx-auto text-center px-6">
      ...
      <motion.h2
        ...
        style={{ fontFamily: FONTS.display, color: C.maroon }}
      >
        With Blessings & Joy
      </motion.h2>
      ...
      <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
        {mode === "edit" && (
          <div className="mb-6 flex items-center justify-center gap-3">
            <label className="text-sm" style={{ color: C.goldLight }}>
              Show Countdown
            </label>
            <button
              ...
              className={cn(
                ...
                showCountdown ? `bg-[${C.gold}]` : "bg-white/20",
              )}
            >
              <div
                className={cn(
          ...
          <>
            ...
            <div className="flex items-center justify-center gap-4 md:gap-8">
              {[
                ...
                >
                  <div
                    className="w-16 h-16 md:w-20 md:h-20 rounded-lg flex items-center justify-center border"
                    style={{
                  ...
                  >
                    <span
                      ...
                      style={{ color: C.gold, fontFamily: FONTS.display }}
                    >
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        {isEdit ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {data.events.map((event, i) => {
              const icon =
                INDIAN_EVENT_ICONS[event.eventName.toLowerCase()] || "✨";
              return (
                <motion.div
                  key={event.id || i}
                  ...
                  className="rounded-2xl p-8 border text-center relative overflow-hidden group hover:shadow-lg transition-shadow"
                  style={{
                ...
                >
                  ...
                  {event.mapsUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 mt-3 text-xs tracking-wider uppercase hover:underline"
  ...
  >
    <div className="max-w-3xl mx-auto px-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-12">
        ...
        >
          <div
            className="w-40 h-40 md:w-48 md:h-48 rounded-full mx-auto mb-4 overflow-hidden border-4"
          ...
          <h3
            className="text-2xl"
            style={{ fontFamily: FONTS.script, color: C.maroon }}
          >
            {data.brideName?.split(" ")[0] || "Bride"}
          </h3>
          {data.brideBio && (
            <p
              className="text-sm mt-2 italic max-w-[200px] mx-auto"
              style={{ color: C.textMuted }}
            >
              {data.brideBio}
            </p>
        ...
        >
          ...
          >
            <img
              src={
                data.groomPhotoUrl || `${R2_BASE}/templates/7/photos/Pose.png`
              }
              alt="Groom"
              className="w-full h-full object-cover"
            />
      ...
      {data.hashtag && (
        ...
        >
          <p
            ...
            style={{ color: C.maroon, fontFamily: FONTS.script }}
          >
            {data.hashtag}
          </p>
        </motion.div>
            ...
            <AnimatePresence>
              {lightboxUrl && (
                <motion.div
                  ...
                  style={{ backgroundColor: `${C.maroonDark}F0` }}
                  onClick={() => setLightboxUrl(null)}
                >
                  <button
                    onClick={() => setLightboxUrl(null)}
                    className="absolute top-4 right-4 p-2 text-white/80 hover:text-white text-2xl"
                  >
                    ✕
                  </button>
                  <motion.img
      ...
      <section className="py-20" style={{ backgroundColor: C.cream }}>
        <div className="max-w-md mx-auto px-6">
          <motion.div
            ...
            style={{ backgroundColor: C.white, borderColor: `${C.gold}30` }}
          >
            <Check
      ...
      <div className="max-w-md mx-auto px-6">
        ...
        >
              ...
              {[
                ...
                <button
                  ...
                  className={cn(
                    ...
                    attending === opt.v ? "ring-2 shadow-md" : "opacity-70",
                  )}
                  style={{
                    borderColor: attending === opt.v ? C.maroon : `${C.gold}30`,
                    backgroundColor:
                      attending === opt.v ? `${C.maroon}10` : C.ivory,
                    ["--tw-ring-color" as any]: C.maroon,
                  }}
                >
            ...
            <div>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <span
                  ...
                  style={{ color: C.maroon, fontFamily: FONTS.display }}
                >
                  {guestCount}
                </span>
                <button
          ...
          <button
            ...
            style={{ backgroundColor: C.maroon, color: C.gold }}
          >
            {loading ? (
