        ...
        <div className="container mx-auto px-4 max-w-lg text-center">
          ...
          >
            ...
            <p className="font-body text-sm text-muted-foreground">
              We'll reach out within 24 hours to discuss your dream invitation.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full rounded-xl border border-border bg-card px-4 py-3 font-body text-sm focus:outline-none focus:ring-2 focus:ring-gold/30 resize-none"
              placeholder="Describe your dream invitation — colors, style, culture, any inspiration..."
            />
          </div>
          <div>
            <label className="font-body text-sm font-medium block mb-1.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-gold w-full py-3.5 rounded-xl text-base flex items-center justify-center gap-2 disabled:opacity-50"
          >
