    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="mb-6">
            <span className="font-body text-xs font-semibold text-emerald uppercase tracking-widest">
              Free
            </span>
          ...
          <div className="text-center mb-6">
            <span className="font-display text-5xl font-bold text-emerald">
              ₹0
            </span>
          </div>
          ...
          <a
            href="#templates"
            className="btn-emerald w-full py-3 rounded-xl text-base block text-center"
          >
            Start Free →
          </a>
        </motion.div>
        ...
        >
          ...
          <div className="mb-6">
            <span className="font-body text-xs font-semibold text-gold uppercase tracking-widest">
              Premium
            </span>
            <h3 className="font-display text-2xl font-semibold mt-2">
              Exclusive Designs
            ...
            <p className="font-body text-sm text-muted-foreground mt-1">
              Hand-crafted premium templates.
            </p>
          </div>
          <div className="text-center mb-6">
          ...
          <a
            href="#templates"
            className="btn-gold w-full py-3 rounded-xl text-base block text-center"
          >
      ...
      <div className="flex items-center justify-center gap-6 mt-10 text-xs text-muted-foreground font-body">
        <span className="flex items-center gap-1.5">
          <Lock size={13} /> Secure Payments
        </span>
        <span className="flex items-center gap-1.5">
          <Zap size={13} /> Instant Publish
        </span>
        <span className="flex items-center gap-1.5">
          <RefreshCcw size={13} /> Edit Anytime
        </span>
      </div>
    </div>
  </section>
