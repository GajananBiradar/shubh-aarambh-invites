    ...
    >
      ...
      <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden bg-background">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 30% 20%, hsl(var(--primary)) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, hsl(var(--accent)) 0%, transparent 50%)",
          }}
        />
        ...
        <div className="relative z-10 text-center px-6 max-w-2xl">
          ...
          {mode === "edit" ? (
            <div className="mt-4">
              <label className="font-body text-xs text-muted-foreground block mb-1 tracking-wider uppercase">
                Wedding Date
              </label>
              <input
                type="date"
            ...
            >
              <div className="text-center">
                <p className="font-heading text-2xl font-bold text-foreground leading-none">
                  {data.weddingDate
                    ? new Date(data.weddingDate).getDate()
                    : "—"}
                </p>
                <p className="font-body text-xs text-muted-foreground uppercase tracking-wider">
                  {data.weddingDate
                    ? new Date(data.weddingDate).toLocaleDateString("en", {
                        month: "short",
                        year: "numeric",
                      })
                    : ""}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-xl">
                        {eventLeafIcons[event.eventName] || "🌿"}
                      </span>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <p className="font-body text-[10px] text-muted-foreground/40 mt-8">
